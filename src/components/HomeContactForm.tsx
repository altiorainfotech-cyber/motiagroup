...
export default function HomeContactForm() {
  ...
  return (
    <section className="px-6 py-16 sm:py-20">
      <h2 className="text-center text-2xl uppercase tracking-wide text-[#377f45] sm:text-3xl">Contact Us</h2>

      <div className="home-contact-form-card mt-10 bg-gray-50 p-8 sm:p-12">
        {submitted ? (
          <p className="text-center text-lg text-gray-700">Thank you! We&rsquo;ve received your message and will get back to you soon.</p>
        ) : (
