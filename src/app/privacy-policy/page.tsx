      ...
      <section className="mx-auto max-w-5xl px-6 py-16 sm:py-20 lg:px-8">
        <Reveal variant="up" className="space-y-6 text-gray-700">
          ...
          <p>
            ...
            disclosure of Personal Information if anyone decided to use our Service, the Motia&rsquo;z website.
          </p>
          ...
          <p>
            ...
            accessible at www.motiagroup.com, unless otherwise defined in this Privacy Policy. Our Privacy Policy
            was created with the help of the Privacy Policy Template.
          </p>

          <h3 className="text-lg font-semibold text-[#377f45]">Information Collection and Use</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Log Data</h3>
          <p>
            We want to inform you that whenever you visit our Service, we collect information that your browser
            sends to us that is called Log Data. This Log Data may include information such as your computer&rsquo;s
            Internet Protocol (&ldquo;IP&rdquo;) address, browser version, pages of our Service that you visit, the
            time and date of your visit, the time spent on those pages, and other statistics.
          </p>

          <h3 className="text-lg font-semibold text-[#377f45]">Cookies</h3>
          <p>
            Cookies are files with small amount of data that is commonly used an anonymous unique identifier. These
            are sent to your browser from the website that you visit and are stored on your computer&rsquo;s hard
            drive.
          </p>
          <p>
            Our website uses these &ldquo;cookies&rdquo; to collection information and to improve our Service. You
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Service Providers</h3>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Security</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Links to Other Sites</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Children&rsquo;s Privacy</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Changes to This Privacy Policy</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-[#377f45]">Meter Policy</h3>
          <p>
            <span className="font-semibold">Refund Policy:</span> All sales of meters will be considered as final.
            No refund will be issued on payments, once done.
          </p>
          <p>
            <span className="font-semibold">Cancellation Policy:</span> All sales of meters will be considered as
            final. No refund will be issued on payments, once done.
          </p>

          <h3 className="text-lg font-semibold text-[#377f45]">Contact Us</h3>
          <p>
