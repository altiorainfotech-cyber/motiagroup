    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-3">
          {jobs.map(({ title, icon: Icon, text }, i) => (
            <Reveal key={title} variant="up" delay={i * 120}>
              <div className="flex flex-col items-center rounded-2xl border border-[#377f45]/20 bg-white p-8 text-center shadow-[0_0_20px_-2px_rgba(55,127,69,0.2)] transition-shadow hover:shadow-[0_0_30px_-2px_rgba(55,127,69,0.4)]">
